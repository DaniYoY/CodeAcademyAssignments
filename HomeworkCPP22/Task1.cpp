...
public:
    CustomVector(): m_size{initSize}, m_capacity{initSize}, m_arr{new int[initSize]} {
    };
    CustomVector(const size_t& capacity): m_size{capacity}, m_capacity{capacity}, m_arr{new int[capacity]}  {
